...
import com.onbada.seathermo.data.storage.FileCreateResult
import com.onbada.seathermo.data.storage.FileStorageError
...
enum class FDFilePathType {
    ...
    fun getPath(context: Context): String {
        val filesDir = context.filesDir  // Internal Storage: /data/data/com.onbada.seathermo/files/
        return when (this) {
