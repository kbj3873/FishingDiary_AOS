...
import com.onbada.seathermo.application.di.DataServiceDIContainer
...
class MainHomeActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        btnSeaTemperature.setOnClickListener {
            val intent = android.content.Intent(this, com.onbada.seathermo.presentation.seawatertemperature.SeaWaterTemperatureActivity::class.java)
            startActivity(intent)
        }

        // 포인트 버튼 클릭 시
        btnPoint.setOnClickListener {
            val intent = android.content.Intent(this, com.onbada.seathermo.presentation.point.list.PointDateListActivity::class.java)
            startActivity(intent)
        }
        ...
        btnStartTracking.setOnClickListener {
            ...
            val intent = android.content.Intent(this, com.onbada.seathermo.presentation.track.TrackMapActivity::class.java)
            startActivity(intent)
        }
