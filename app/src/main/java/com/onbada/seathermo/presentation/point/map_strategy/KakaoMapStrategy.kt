...
class KakaoMapStrategy(
    ...
    override fun addMarker(pin: MapPin, onClick: (MapPin) -> Unit) {
        ...
        val styles = com.kakao.vectormap.label.LabelStyles.from(
            com.kakao.vectormap.label.LabelStyle.from(com.onbada.seathermo.R.drawable.ic_point)
        )
    ...
    fun updateMyLocation(latLng: LatLng) {
        ...
        val styles = com.kakao.vectormap.label.LabelStyles.from(
            com.kakao.vectormap.label.LabelStyle.from(com.onbada.seathermo.R.drawable.ic_my_location)
